...
const BLURBS = {
  ...
  41: "Localized page content + hreflang tags.",
  43: "Predicts score lift of a proposed change.",
  49: "Recommends the full agent workflow sequence.",
  50: "Plain-English request → GEO action plan.",
  52: "GEO score → revenue & lead ROI projection.",
  46: "Top authority sources + outreach plan.",
  47: "Smart review reply + follow-up actions.",
  53: "Industry-specific GEO templates.",
  56: "Conversion audit (12-point) + CTA fixes.",
  58: "Featured-snippet + PAA blocks + schema.",
  59: "WCAG accessibility audit + code fixes.",
...
const FIELD_LABELS = {
  ...
  leadCaptureMethod: "Lead capture (form/phone/booking)",
  languages: "Target language(s)",
  proposedChange: "Proposed change",
  currentScore: "Current GEO score (optional)",
  workflow: "Desired workflow",
  request: "What do you want to do?",
  ltv: "Avg customer LTV (optional)",
  monthlyLeads: "Current monthly leads/traffic (optional)",
};
const PLACEHOLDERS = {
  ...
  languages: "Hawaiian, Japanese, Tagalog",
  proposedChange: "Add FAQ schema to the homepage",
  currentScore: "44",
  workflow: "Full monthly optimization",
  request: "Optimize my roofing site in Maui",
  ltv: "8000",
  monthlyLeads: "40",
